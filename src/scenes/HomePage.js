...
export default function HomePage() {
    const features = [
        ...
        },
        {
            ...
            imgAlt: 'Featurre tile icon 02',
            title: 'Join IconHunt',
            description: 'A pseudo-Latin text used in web design, layout, and printing in place of things to emphasise design.',
        },
        {
            imgSrc: FeatureTile03,
            imgAlt: 'Featurre tile icon 03',
            title: 'Join NineOne',
            description: 'A pseudo-Latin text used in web design, layout, and printing in place of things to emphasise design.',
        },
    ];
            ...
            <Section className="pricing">
                <div className="container">
						<div className="pricing-inner section-inner has-top-divider">
							...
							<div className="tiles-wrap">
                                {
                                    listPricing.map((list, index) => <Card hasShadow delasyMS={index * 500}>
                                    <div className="pricing-item-content">
											<div
												...
												<div
													...
													<span
														className="pricing-item-price-currency h2">{list.currencySymbol}</span>
                                                    <span
											...
											<div
                                                ...
                                                <Lists
                                                data={list.features} isSmall className="pricing-item-features-list mb-32"/>
											</div>
										</div>
